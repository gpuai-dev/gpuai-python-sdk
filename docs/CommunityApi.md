...
[**get_community_earnings**](CommunityApi.md#get_community_earnings) | **GET** /community/earnings | Get your Community Cloud earnings
[**get_community_machine**](CommunityApi.md#get_community_machine) | **GET** /community/machines/{id} | Get one of your Community Cloud machines
...
[**update_community_machine**](CommunityApi.md#update_community_machine) | **PATCH** /community/machines/{id} | Update a Community Cloud machine&#39;s price
...
# **get_community_earnings**
> CommunityEarnings get_community_earnings(limit=limit)
...
with gpuai_sdk.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = gpuai_sdk.CommunityApi(api_client)
    limit = 56 # int | Maximum ledger entries to return (default 100, max 500). (optional)

    try:
        # Get your Community Cloud earnings
        api_response = api_instance.get_community_earnings(limit=limit)
        print("The response of CommunityApi->get_community_earnings:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CommunityApi->get_community_earnings: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **limit** | **int**| Maximum ledger entries to return (default 100, max 500). | [optional] 
...
# **get_community_machine**
> SupplierMachineView get_community_machine(id)
...
with gpuai_sdk.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = gpuai_sdk.CommunityApi(api_client)
    id = 'id_example' # str | The machine id.

    try:
        # Get one of your Community Cloud machines
        api_response = api_instance.get_community_machine(id)
        print("The response of CommunityApi->get_community_machine:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CommunityApi->get_community_machine: %s\n" % e)
```
...
# **update_community_machine**
> SupplierMachineView update_community_machine(id, update_community_machine_request)
...
with gpuai_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = gpuai_sdk.CommunityApi(api_client)
    id = 'id_example' # str | The machine id.
    update_community_machine_request = gpuai_sdk.UpdateCommunityMachineRequest() # UpdateCommunityMachineRequest | 

    try:
        # Update a Community Cloud machine's price
        api_response = api_instance.update_community_machine(id, update_community_machine_request)
        print("The response of CommunityApi->update_community_machine:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CommunityApi->update_community_machine: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **id** | **str**| The machine id. | 
 **update_community_machine_request** | [**UpdateCommunityMachineRequest**](UpdateCommunityMachineRequest.md)|  | 
