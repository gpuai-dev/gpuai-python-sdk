# gpuai_sdk.TemplatesApi

All URIs are relative to *https://api.gpu.ai/v1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_template**](TemplatesApi.md#get_template) | **GET** /templates/{id} | Get one deployable application template
[**list_templates**](TemplatesApi.md#list_templates) | **GET** /templates | List deployable application templates
...
with gpuai_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = gpuai_sdk.TemplatesApi(api_client)
    id = 'id_example' # str | 
