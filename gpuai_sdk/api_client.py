...
from gpuai_sdk.configuration import Configuration
from gpuai_sdk.api_response import ApiResponse, T as ApiResponseT
import gpuai_sdk.models
from gpuai_sdk import rest
from gpuai_sdk.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(gpuai_sdk.models, klass)
