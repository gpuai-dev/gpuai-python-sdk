...
class Configuration:
    ...
    def __init__(
        ...
        *,
        ...
        """Constructor
        """
        self._base_path = "https://api.gpu.ai/v1" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("gpuai_sdk")
    ...
    def get_host_settings(self) -> List[HostSetting]:
        ...
        return [
            {
                'url': "https://api.gpu.ai/v1",
                'description': "Production",
            },
            {
                'url': "https://api.demo.gpu.ai/v1",
                'description': "Demo",
            }
        ]
