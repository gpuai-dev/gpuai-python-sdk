...
class IncludeItem(BaseModel):
    ...
    IncludeItem
    """ # noqa: E501
    name: StrictStr = Field(json_schema_extra={"examples": ["PyTorch"]})
    version: Optional[StrictStr] = Field(default=None, description="Resolved build version; absent for unpinned components (e.g. git).", json_schema_extra={"examples": ["2.13.0"]})
