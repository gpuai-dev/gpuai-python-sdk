...
class CommunityEarnings(BaseModel):
    """
    CommunityEarnings
    """ # noqa: E501
    accrued_cents: StrictInt = Field(description="Lifetime accrued earnings in cents.")
    unpaid_cents: StrictInt = Field(description="Accrued but not yet paid out, in cents.")
    entries: List[CommunityEarningsEntry]
    __properties: ClassVar[List[str]] = ["accrued_cents", "unpaid_cents", "entries"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "accrued_cents": obj.get("accrued_cents"),
            "unpaid_cents": obj.get("unpaid_cents"),
            "entries": [CommunityEarningsEntry.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None
        })
        return _obj
