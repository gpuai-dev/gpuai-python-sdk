...
class CommunityMachineRegistration(BaseModel):
    """
    CommunityMachineRegistration
    """ # noqa: E501
    machine: CommunityMachine
    enrollment_token: StrictStr = Field(description="One-time enrollment token — shown exactly once, store securely.")
    __properties: ClassVar[List[str]] = ["machine", "enrollment_token"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "machine": CommunityMachine.from_dict(obj["machine"]) if obj.get("machine") is not None else None,
