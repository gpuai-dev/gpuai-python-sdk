...
class CreateFineTuningJobRequestGpuai(BaseModel):
    """
    CreateFineTuningJobRequestGpuai
    """ # noqa: E501
    max_budget_usd: Optional[Union[StrictFloat, StrictInt]] = None
    gpu_preference: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["max_budget_usd", "gpu_preference"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "max_budget_usd": obj.get("max_budget_usd"),
            "gpu_preference": obj.get("gpu_preference")
        })
        return _obj
