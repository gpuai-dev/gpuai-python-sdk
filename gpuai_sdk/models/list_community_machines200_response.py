...
class ListCommunityMachines200Response(BaseModel):
    """
    ListCommunityMachines200Response
    """ # noqa: E501
    machines: List[SupplierMachineView]
    __properties: ClassVar[List[str]] = ["machines"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "machines": [SupplierMachineView.from_dict(_item) for _item in obj["machines"]] if obj.get("machines") is not None else None
        })
        return _obj
