...
class ModelParametersInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "type", "enum", "min", "max", "default"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['enum', 'int', 'string', 'bool']):
            raise ValueError("must be one of enum values ('enum', 'int', 'string', 'bool')")
        return value
