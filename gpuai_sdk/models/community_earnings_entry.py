...
class CommunityEarningsEntry(BaseModel):
    """
    ...
    accrued_at: datetime
    paid: StrictBool
    __properties: ClassVar[List[str]] = ["ledger_id", "machine_id", "instance_id", "amount_cents", "accrued_at", "paid"]
