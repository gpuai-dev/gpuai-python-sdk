...
------------ | ------------- | ------------- | -------------
*BillingApi* | [**create_crypto_deposit**](https://github.com/gpuai-dev/gpuai-python-sdk/blob/main/docs/BillingApi.md#create_crypto_deposit) | **POST** /billing/deposits/crypto | Create a stablecoin deposit
*BillingApi* | [**get_deposit**](https://github.com/gpuai-dev/gpuai-python-sdk/blob/main/docs/BillingApi.md#get_deposit) | **GET** /billing/deposits/{id} | Get one stablecoin deposit
...
*BillingApi* | [**list_deposits**](https://github.com/gpuai-dev/gpuai-python-sdk/blob/main/docs/BillingApi.md#list_deposits) | **GET** /billing/deposits | List stablecoin deposits
...
## Documentation For Models
 ...
 - [CreateCryptoDepositRequest](https://github.com/gpuai-dev/gpuai-python-sdk/blob/main/docs/CreateCryptoDepositRequest.md)
 ...
 - [CryptoDeposit](https://github.com/gpuai-dev/gpuai-python-sdk/blob/main/docs/CryptoDeposit.md)
 ...
 - [ListDeposits200Response](https://github.com/gpuai-dev/gpuai-python-sdk/blob/main/docs/ListDeposits200Response.md)
